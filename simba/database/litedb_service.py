...
class LiteDocumentDB:
    ...
    def _initialize(self):
        """Initialize the database"""
        try:
            self._conn = sqlite3.connect(str(self.db_path), check_same_thread=False, timeout=60.0)
    ...
    def insert_documents(self, documents: SimbaDoc | List[SimbaDoc], user_id: str = None) -> List[str]:
    ...
    def get_document(self, document_id: str | List[str], user_id: str = None) -> Optional[SimbaDoc] | List[SimbaDoc]:
        """Retrieve a document by ID or list of IDs"""
    ...
    def update_document(self, document_id: str, newDocument: SimbaDoc, user_id: str = None) -> bool:
