...
class AuthService:
    ...
    async def sign_up(email: str, password: str, user_metadata: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                # Log but don't fail sign up just because role assignment failed
    ...
    async def sign_in(email: str, password: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # Check for Mock client
            if supabase.__class__.__name__ == "MockSupabaseClient":
                logger.info(f"MOCK: User signed in successfully: {email}")
    ...
    async def get_user(access_token: str) -> Dict[str, Any]:
        ...
        """
        try:
            # Handle mock token for local dev
            if access_token == "mock-access-token":
                logger.debug("Validating MOCK token")
                return {
                    "id": "mock-user-id",
